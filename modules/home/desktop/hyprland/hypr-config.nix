...
in {
  wayland.windowManager.hyprland = {
    extraConfig = "
      ...
      exec-once = dbus-updatye-activation-environment --systemd &
      exec-once = rm-applet &
      ...
      bind = ALT, backspace, exec, kitty --title float_kitty
      bind = $mainMod SHIFT, backspace, exec, kitty --start-as=fullscreen -o 'font_size=16'
